...
export default function ChannalBar() {
  ...
  return (
    <aside className="md:w-60 w-full  bg-white text-black  border-r border-gray-200 flex flex-col transition-all duration-200 overflow-scroll h-screen">
